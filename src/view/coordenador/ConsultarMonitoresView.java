 ...
 * @author Thiago Sena
 */
public class ConsultarMonitoresView extends javax.swing.JFrame {

    /**
     * Creates new form ListaTornarAlunoMonitorView
     */
    public ConsultarMonitoresView() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tblDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Disciplina", "Ciclo Letivo", "Matrícula"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarMonitoresView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarMonitoresView().setVisible(true);
            }
        });
    }
