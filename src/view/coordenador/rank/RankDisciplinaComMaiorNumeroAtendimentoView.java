 ...
 * @author Thiago Sena
 */
public class RankDisciplinaComMaiorNumeroAtendimentoView extends javax.swing.JFrame {

    /**
     * Creates new form ListaTornarAlunoMonitorView
     */
    public RankDisciplinaComMaiorNumeroAtendimentoView() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RankDisciplinaComMaiorNumeroAtendimentoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RankDisciplinaComMaiorNumeroAtendimentoView().setVisible(true);
            }
        });
    }
