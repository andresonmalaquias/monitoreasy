 ...
 * @author Thiago Sena
 */
public class ConsultarAtendimentosMonitorView extends javax.swing.JFrame {

    /**
     * Creates new form ListaTornarAlunoMonitorView
     */
    public ConsultarAtendimentosMonitorView() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarAtendimentosMonitorView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarAtendimentosMonitorView().setVisible(true);
            }
        });
    }
